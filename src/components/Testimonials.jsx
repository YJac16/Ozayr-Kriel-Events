...
const Testimonials = () => {
  ...
  const testimonials = [
    { name: 'Sarah & James', event: 'Wedding', text: "Ozayr made our wedding day absolutely perfect. Every detail was handled with care, and we could truly enjoy our special day without any stress. Her warm personality and attention to detail are unmatched.", rating: 5 },
  ...
  return (
    <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-ink-950">
        ...
        <div className="relative">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-ink-800/80 rounded-3xl p-8 md:p-12 shadow-xl border border-ink-700"
            >
              <Quote className="w-12 h-12 text-gold-500/70 mb-6" />
              <p className="text-xl md:text-2xl text-ink-200 leading-relaxed mb-8 font-light italic">
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 w-12 h-12 bg-ink-800 rounded-full shadow-lg flex items-center justify-center hover:bg-ink-700 border border-ink-600 transition-colors"
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 w-12 h-12 bg-ink-800 rounded-full shadow-lg flex items-center justify-center hover:bg-ink-700 border border-ink-600 transition-colors"
