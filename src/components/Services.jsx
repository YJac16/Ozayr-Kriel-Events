...
const Services = () => {
  const services = [
    ...
    { icon: Flame, title: 'Braai Facilities & Expert Chefs', description: 'Premium braai experiences with skilled chefs, quality cuts, and perfectly timed service.', color: 'gold' },
  ]
