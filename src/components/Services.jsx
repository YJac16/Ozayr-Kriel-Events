...
const Services = () => {
  const services = [
    ...
    { icon: Flame, title: 'Braai Facilities & Expert Chefs', description: 'Our professional braai facilities and experienced braai chefs bring flavour, precision, and efficiency to your event. From premium cuts to perfectly prepared sides, we ensure every dish is cooked to perfection and served fresh, hot, and on time. With careful planning and smooth service flow, your guests enjoy delicious food without long waits — just quality meals and great memories.', color: 'gold' },
  ]
          ...
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <p className={`text-sm sm:text-base text-ink-300 leading-relaxed ${service.title.includes('Braai') ? 'max-h-40 overflow-y-auto pr-1' : ''}`}>
                  {service.description}
                </p>
              </motion.div>
            )
